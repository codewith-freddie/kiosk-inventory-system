...
Year Level"
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        Try
            ...
            ClearFields()
            Me.Close()
            Dim login As New LoginDashboard
            login.Show()
