...
Public Class History
    ...
    Private Sub txtSearch_TextChanged(sender As Object, e As EventArgs) Handles txtSearch.TextChanged
        Try
            ...
            Dim query As String = "SELECT * FROM history WHERE returnedID LIKE @SearchText OR BorrowedID LIKE @SearchText OR UserID LIKE @SearchText OR ItemID LIKE @SearchText OR Category LIKE @SearchText OR ItemName LIKE @SearchText OR Description LIKE @SearchText OR Quantity LIKE @SearchText OR Remarks LIKE @SearchText OR dateTIME = @SearchDate"
