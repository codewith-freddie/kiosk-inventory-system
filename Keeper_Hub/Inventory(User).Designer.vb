...
Partial Class UserInventory
    ...
    Private Sub InitializeComponent()
        ...
        dgvInventory.Location = New Point(34, 153)
        dgvInventory.Name = "dgvInventory"
        dgvInventory.ReadOnly = True
        dgvInventory.RowHeadersWidth = 51
        dgvInventory.RowTemplate.Height = 29
        dgvInventory.Size = New Size(953, 343)
        dgvInventory.TabIndex = 121
        ' 
        ' btnBorrow
        ' 
        btnBorrow.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        btnBorrow.BackColor = Color.FromArgb(CByte(9), CByte(96), CByte(79))
        btnBorrow.Font = New Font("Segoe UI", 13.8F, FontStyle.Bold, GraphicsUnit.Point)
        btnBorrow.ForeColor = Color.White
        btnBorrow.Location = New Point(407, 511)
        btnBorrow.Name = "btnBorrow"
        btnBorrow.Size = New Size(186, 57)
        btnBorrow.TabIndex = 126
        ...
        txtSearch.Location = New Point(102, 106)
        txtSearch.Name = "txtSearch"
        txtSearch.Size = New Size(318, 27)
        txtSearch.TabIndex = 133
        ' 
        ' btnRefresh
        ' 
        ...
        btnRefresh.Location = New Point(930, 107)
        ...
        lbUserID.Location = New Point(70, 30)
        lbUserID.Name = "lbUserID"
        lbUserID.Size = New Size(66, 23)
        lbUserID.TabIndex = 134
